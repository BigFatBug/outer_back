        ...
        <div id="content">
            ...
            <div class="content-wrapper">
                ...
                <div class="outlet">
                    ...
                    <div class="col-md-5">
                    <select class="form-control" name="group_id" id="group_upload">
                            ...
                            <div class="panel panel-default plain toggle panelClose panelRefresh">
                                ...
                                <ul id="crumb" class="breadcrumb">
                                    <form class="form-search" id="find" onsubmit="return find();">
                                        <div class="col-md-6">
                                        <select class="form-control" name="group_id" id="group_choose">
                                            <option value="">请选择分组</option>
                                        </select>
                                        </div>
                                        <input type="text" name="begin_time" class="ui_timepicker" value=""  placeholder="时间范围左值">
                                        <input type="text" name="end_time" class="ui_timepicker" value=""  placeholder="时间范围右值">
